...
docker build -f Dockerfile.prod-opt -t rails-thelighthouse-prod-opt:"$tag_number" ./

#Tag image
echo "Tagging Image for Heroku Registry"
docker tag rails-thelighthouse-prod-opt:"$tag_number" registry.heroku.com/discoverthelighthouse/web
