...
Além de um processo, coaching é parceria, portanto você terá um acompanhamento personalizado e focado nos seus objetivos e necessidades, alinhado ao que traz sentido para si.", tagline: "Alcance objetivos com autoconhecimento, autonomia e confiança.", hp_show: true, structure: "8 a 10 sessões de 1 hora, presencial ou online.")
...
life_coaching = Service.create(name: "Life Coaching",  nickname: "Coaching", description: "O coaching é um processo poderoso de desenvolvimento e  autoconhecimento, que provoca mudanças comportamentais, levando o coachee à reflexão sobre questões importantes para si, potencializando forças e reduzindo crenças limitantes. Embarque neste delicioso processo de transformação pessoal e tenha mais segurança e autoconhecimento para alcançar os seus objetivos alinhando-se ao que faz sentido para si.", tagline: "Para aqueles que buscam autoconhecimento, conexão com a sua verdade e alinhamento entre talento e propósito.", structure: "8 a 10 sessões de 1 hora, presencial ou online.", hp_show: false)
