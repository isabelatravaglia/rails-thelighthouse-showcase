...
executive_coaching_image_file = URI.open('https://images.unsplash.com/photo-1490111718993-d98654ce6cf7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80')
executive_coaching.photo.attach(io: executive_coaching_image_file, filename: 'executive_coaching.jpg', content_type: 'image/jpg')
...
carreira = Service.create(name: "Planejamento de Carreira", nickname:"Carreira", description: "O mundo está cheio de possibiliades maravilhosas, mas nem sempre é fácil saber qual caminho trilhar ou qual direção está mais alinhada com o que faz sentido para nós. Um plano de carreira individual estruturado, te  ajudará a ter mais clareza dos próximos passos." , tagline: "Obtenha autoconhecimento, segurança e mais clareza nos próximos passos de carreira.", hp_show: true, structure: "6 a 8 sessões de 1 hora, presencial ou online.")
...
AudienceService.create(service: executive_coaching, audience: recoloc)
AudienceService.create(service: life_coaching, audience: company)
