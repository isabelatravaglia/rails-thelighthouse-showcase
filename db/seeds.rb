...
autoconhecimento = Service.create(name: "Testes de Perfil", nickname:"Testes de Perfil", description: "Aplicação e devolutiva do teste de personalidade MBTI (Myers-Briggs Type Indicator) e do Firo B. Ambos testes proporcionam análise de perfil por meio da identificação de talentos, necessidades e tendências comportamentais; auxílio na adequação do talento a carreira; identificação de características de liderança, padrões de comunicação e seus impactos; levantamento de campos de força e áreas de stress." , tagline: "Autoconhecimento, testes de perfil e pistas para próximos passos de carreira.", hp_show: true, structure: "2 encontros de 1 hora e meia cada.")
